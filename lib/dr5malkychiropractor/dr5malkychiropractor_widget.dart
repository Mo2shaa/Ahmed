...
class Dr5malkychiropractorWidget extends StatefulWidget {
  Dr5malkychiropractorWidget({Key key}) : super(key: key);

  @override
  _Dr5malkychiropractorWidgetState createState() =>
      _Dr5malkychiropractorWidgetState();
}

class _Dr5malkychiropractorWidgetState
    extends State<Dr5malkychiropractorWidget> {
